...
st.set_page_config(page_title="ThalLink แพลตฟอร์มวิเคราะห์ความเสี่ยงและแปลผลธาลัสซีเมีย", page_icon="🩸", layout="wide")
inject_css()
sidebar_brand("Command center")

hero(
    "ThalLink: Thalassemia Laboratory Consult — Expert Edition",
